...
public class ResourceEndpointTest extends AbstractBulkTest implements FileReferences
{
  ...
  public void testCreateResource()
  {
    ...
    Mockito.verify(userHandler, Mockito.times(0))
           .getResource(Mockito.any(), Mockito.isNull(), Mockito.isNull(), Mockito.isNull(), Mockito.any());
  ...
  public void testCreateResourceWithMissingExtensionUriInSchemas()
  {
    ...
    Mockito.doReturn(user).when(userHandler).createResource(Mockito.any(), Mockito.isNull(), Mockito.any());
  ...
  public void testDeleteResource()
  {
    ...
    Mockito.verify(userHandler, Mockito.times(0))
           .getResource(Mockito.any(), Mockito.isNull(), Mockito.isNull(), Mockito.isNull(), Mockito.isNull());
    Mockito.verify(userHandler, Mockito.times(0)).updateResource(Mockito.any(), Mockito.isNull(), Mockito.any());
    Mockito.verify(userHandler, Mockito.times(1)).deleteResource(Mockito.any(), Mockito.isNull(), Mockito.any());
    Mockito.verify(userHandler, Mockito.times(0))
           .listResources(Mockito.anyLong(),
                          Mockito.anyInt(),
                          Mockito.any(),
  ...
  public void testSendBulkRequest()
  {
    ...
    Mockito.verify(userHandler, Mockito.times(maxOperations)).createResource(Mockito.any(), Mockito.isNull(), Mockito.any());
  ...
  public void testFailOnErrorsWorks(int failOnErrors)
  {
    ...
    Mockito.doThrow(new BadRequestException("something bad", null, null))
           .when(userHandler)
           .createResource(Mockito.any(), Mockito.isNull(), Mockito.any());
    List<BulkRequestOperation> createOperations = getCreateUserBulkOperations(maxOperations);
  ...
  public List<DynamicTest> testAuthorized()
  {
    ...
    dynamicTests.add(DynamicTest.dynamicTest("create authorized", () -> {
      ScimResponse scimResponse = resourceEndpoint.handleRequest(url,
                                                                 ...
                                                                 clientAuthorization);
      MatcherAssert.assertThat(scimResponse.getClass(), Matchers.typeCompatibleWith(CreateResponse.class));
      Mockito.verify(userHandler, Mockito.times(1)).createResource(Mockito.any(), Mockito.eq(clientAuthorization), Mockito.any());
    ...
    dynamicTests.add(DynamicTest.dynamicTest("patch authorized", () -> {
      ...
      Mockito.verify(userHandler, Mockito.times(1))
             .getResource(Mockito.any(),
                          Mockito.eq(clientAuthorization),
                          Mockito.eq(Collections.emptyList()),
                          Mockito.eq(Collections.emptyList()), Mockito.any());
      Mockito.verify(userHandler, Mockito.times(1)).updateResource(Mockito.any(), Mockito.eq(clientAuthorization), Mockito.any());
      Mockito.clearInvocations(userHandler);
    }));
    /* ************************************************************************************************************/
    dynamicTests.add(DynamicTest.dynamicTest("delete authorized", () -> {
      ScimResponse scimResponse = resourceEndpoint.handleRequest(url + "/" + id,
                                                                 ...
                                                                 clientAuthorization);
      MatcherAssert.assertThat(scimResponse.getClass(), Matchers.typeCompatibleWith(DeleteResponse.class));
      Mockito.verify(userHandler, Mockito.times(1)).deleteResource(Mockito.any(), Mockito.eq(clientAuthorization), Mockito.any());
    }));
    /* ************************************************************************************************************/
    return dynamicTests;
  }
